am4core.ready(function() {
    ...
    illinoisCountySeries.useGeodata = false;

    // var ilCountyData = [];
    // for (var id in ilCounty.features) {
    //     var county = ilCounty.features[id];
    //     console.log(county);
    //     ilCountyData.push({
    //         "id": id,
    ...
    // illinoisCountySeries.data = ilCountyData;
    ...
    illinoisCountySeries.data = [
        { id: "15", value: 60.524, fill: "#0000FF" }
    ];
    // worldSeries.hide();
